      ...
      <DrawerContent className="bg-card border-l border-border shadow-2xl">
        ...
        <div className="no-scrollbar overflow-y-auto px-4">
          {/* <p>Développeur web en devenir, d’origine corse,
            ...
            <br/>devenu aujourd’hui un véritable projet professionnel. Curieus et motivé, je conçois des projets web en mettant l’accent sur la logique, la créativité et l’expérience utilisateur.</p> */}
          ...
          <p>Développeur front-end spécialisé en React et SCSS, je conçois des interfaces modernes, dynamiques et responsive.
             ...
             <br/><br/>Je suis aujourd'hui à la recherche d'un poste pour mettre mes compétences en pratique et continuer à progresser.</p>
