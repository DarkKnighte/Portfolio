    ...
    <div className={`about-drawer ${open ? 'about-drawer--open' : ''}`}>
      ...
      <div className="about-drawer__content">
        ...
        <p>
          ...
          <br/><br/>J'ai par la suite continuer ma formation OpenClassroom sans alternance afin de pouvoir la finir dans de meilleures conditions de travails possible, et me concentrer sur des projets personnels pour mettre en pratique mes compétences et continuer à apprendre de nouvelles technologies.
